...
func TestContactMerge_Golden_RichFixturePair(t *testing.T) {
	...
	want := goldenMergeState{
		...
		RelationshipEdges: []string{
			...
			"me|bea|related_to|confirmed|normal|1",
			"me|harold|related_to|confirmed|normal|1",
			"me|marcus|friend_of|confirmed|normal|1",
			"me|margaret|child_of|confirmed|normal|1",
			"me|nadia|partner_of|confirmed|normal|1",
			"me|soren|coworker_of|confirmed|normal|1",
			"me|theo|spouse_of|confirmed|normal|1",
		},
