...
func CreateTag(c *gin.Context) {
	...
	services.TriggerWebhooksAsync(c.Request.Context(), db, currentConfig(c), userID, "tag.created", tag)
...
func UpdateTag(c *gin.Context) {
	...
	services.TriggerWebhooksAsync(c.Request.Context(), db, currentConfig(c), userID, "tag.updated", tag)
...
func DeleteTag(c *gin.Context) {
	...
	services.TriggerWebhooksAsync(c.Request.Context(), db, currentConfig(c), userID, "tag.deleted", gin.H{"id": tag.ID})
