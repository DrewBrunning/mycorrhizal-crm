...
func buildCWTable(s seeded) map[string]cwRow {
	...
	return map[string]cwRow{
		...
		"PUT /api/v1/occasion-obligations/:id":    exempt(reasonNonRevision),
		"DELETE /api/v1/occasion-obligations/:id": exempt(reasonNonRevision),
		// Occasion events (docs/adrs/0026-occasions-events.md, issue #1228): no
		// revision column; attendees are join rows.
		"POST /api/v1/occasion-events":                            exempt(reasonCreate),
		"PUT /api/v1/occasion-events/:id":                         exempt(reasonNonRevision),
		"DELETE /api/v1/occasion-events/:id":                      exempt(reasonNonRevision),
		"POST /api/v1/occasion-events/:id/attendees":              exempt(reasonMembership),
		"PUT /api/v1/occasion-events/:id/attendees/:vcard_uid":    exempt(reasonMembership),
