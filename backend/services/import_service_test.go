...
func TestPhoneKey_CountryCodeReconciliation(t *testing.T) {
	a := PhoneKey("+18005551234")
	b := PhoneKey("(800) 555-1234")
	c := PhoneKey("800-555-1234")
...
func TestPhoneKey_UkTrunkPrefix(t *testing.T) {
	assert.Equal(t, "2079460958", PhoneKey("+44 20 7946 0958"))
	assert.Equal(t, "2079460958", PhoneKey("020 7946 0958"))
	assert.Equal(t, "2079460958", PhoneKey("+44 020 7946 0958"))
}

func TestPhoneKey_ExactlyTen(t *testing.T) {
	assert.Equal(t, "8005551234", PhoneKey("8005551234"))
	assert.Equal(t, "2079460958", PhoneKey("2079460958"))
}

func TestPhoneKey_PunctuationOnly(t *testing.T) {
	assert.Equal(t, "8005551234", PhoneKey("800.555.1234"))
	assert.Equal(t, "8005551234", PhoneKey("800-555-1234"))
	assert.Equal(t, "8005551234", PhoneKey("(800) 555-1234"))
}

func TestPhoneKey_MoreThanTenKeepsLastTen(t *testing.T) {
	assert.Equal(t, "8005551234", PhoneKey("18005551234"))
	assert.Equal(t, "8005551234", PhoneKey("+1 800 555 1234"))
}

func TestPhoneKey_SevenDigits(t *testing.T) {
	assert.Equal(t, "5551234", PhoneKey("555-1234"))
}

func TestPhoneKey_SixDigitsReturnsEmpty(t *testing.T) {
	assert.Equal(t, "", PhoneKey("555123"))
	assert.Equal(t, "", PhoneKey("555-123"))
}

func TestPhoneKey_EmptyStringReturnsEmpty(t *testing.T) {
	assert.Equal(t, "", PhoneKey(""))
}

func TestPhoneKey_NoDigitsReturnsEmpty(t *testing.T) {
	assert.Equal(t, "", PhoneKey("abc def"))
}
...
func TestPhoneKey_VeryLongNumber(t *testing.T) {
	assert.Equal(t, "5512345599", PhoneKey("+1-800-555-1234 ext. 5599"))
}

func TestPhoneKey_NonLatinDigitsAreNotDigits(t *testing.T) {
	assert.Equal(t, "", PhoneKey("１２３４５６７８９０"))
}
