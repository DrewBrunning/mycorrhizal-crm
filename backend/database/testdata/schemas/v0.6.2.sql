-- Schema-only dump for release v0.6.2 (migration version 43).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.2 -version 43`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000043 are byte-identical to the tagged release's own files).
...
CREATE TABLE contacts (
    ...
    fn TEXT DEFAULT '',
    org TEXT DEFAULT ''
, addresses_flat TEXT NOT NULL DEFAULT '', phones_normalized TEXT NOT NULL DEFAULT '', sort_name TEXT NOT NULL DEFAULT '', is_favorite INTEGER NOT NULL DEFAULT 0);
...
INSERT INTO schema_migrations (version, dirty) VALUES (43, 0);
