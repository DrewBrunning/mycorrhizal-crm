-- Schema-only dump for release v0.6.1 (migration version 36).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.1 -version 36`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000036 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (36, 0);
