-- Schema-only dump for release v0.6.0 (migration version 31).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.0 -version 31`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000031 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (31, 0);
