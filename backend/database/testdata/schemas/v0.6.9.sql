-- Schema-only dump for release v0.6.9 (migration version 50).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.9 -version 50`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000050 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (50, 0);
