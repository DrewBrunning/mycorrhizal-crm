-- Schema-only dump for release v0.8.8 (migration version 57).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.8.8 -version 57`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000057 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (57, 0);
