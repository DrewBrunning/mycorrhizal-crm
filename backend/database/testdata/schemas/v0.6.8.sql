-- Schema-only dump for release v0.6.8 (migration version 48).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.8 -version 48`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000048 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (48, 0);
