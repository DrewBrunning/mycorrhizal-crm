-- Schema-only dump for release v0.8.7 (migration version 56).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.8.7 -version 56`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000056 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (56, 0);
