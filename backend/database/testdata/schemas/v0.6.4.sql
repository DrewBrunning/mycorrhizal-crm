-- Schema-only dump for release v0.6.4 (migration version 45).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.4 -version 45`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000045 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (45, 0);
