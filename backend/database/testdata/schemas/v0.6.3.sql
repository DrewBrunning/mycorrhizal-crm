-- Schema-only dump for release v0.6.3 (migration version 44).
-- Generated by `cd backend && go run ./cmd/genschema -tag v0.6.3 -version 44`
-- from the embedded migration chain (frozen and append-only, so migrations
-- 000001..000044 are byte-identical to the tagged release's own files).
...
INSERT INTO schema_migrations (version, dirty) VALUES (44, 0);
