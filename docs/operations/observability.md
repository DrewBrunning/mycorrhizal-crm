...
([#428](https://github.com/DrewBrunning/mycorrhizal-crm/issues/428)) reads it directly. Error
aggregation (below) is a *sibling* fold over the same stream, not a consumer of this one. Rendered at
