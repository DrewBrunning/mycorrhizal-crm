...
| `crm.periods` | `CRMEnvelope.Periods` | **unsupported** — start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file | **unsupported** — start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file | **unsupported** — start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file | **unsupported** — start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file |
...
| `crm.periods` | vCard 4.0 | **unsupported** | start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file |
| `crm.periods` | vCard 3.0 | **unsupported** | start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file |
| `crm.periods` | JSContact | **unsupported** | start/end ranges for addresses/employers/titles (ADR 0025); no RFC 9553/9554/9555 home, so never serialized to a contact file |
