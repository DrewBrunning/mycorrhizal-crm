...
| 14.2.1 | Dependencies current (checker in build) | satisfied | govulncheck (`unit-tests.yml:241-243`), Trivy (`docker-publish.yml:586-603`), Trivy license scan (`license-compliance.yml`, issue #361), Dependabot, Dependency Review |
