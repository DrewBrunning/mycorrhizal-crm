...
| 8.2.1 | Anti-caching headers for browsers | partial | SPA HTML gets `Cache-Control: no-cache` (`docker/nginx.conf:175`); API responses get no anti-cache headers. Gap: same as 8.1.1. |
