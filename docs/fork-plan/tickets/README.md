...
| Ticket | Status |
|---|---|
| [T90](134-T90-mark-contact-as-me.md) · Mark a contact as "Me" (+ web UI) | **TO BE DONE**. R4. M. The column has existed since migration `000018` with no way to set it and a backfill that was documented but never written. |
