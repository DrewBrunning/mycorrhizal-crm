...
| [M1](67-M1-mobile-android-app.md) · Native Android app (Kotlin, Jetpack Compose) | **Phase 1 DONE / Phase 2 DONE / Phase 3 IN PROGRESS** (2026-08-10 — working core client in `android/`: Gradle multi-module build, JWT/API-token auth, contacts list/detail/create/edit, activities/notes/reminders + unified timeline, tappable field actions + link-action enrichment (on-device verified), local FTS search, hand-verified tests, CI workflow. Phase 3 sub-resources: item 14 circles DONE; 15–19 in progress. See the ticket's landing note) |
