...
| Ticket | Status |
|---|---|
| [T107](151-T107-merge-destroys-attachments-and-more.md) · Merge destroys attachments, preferences, cadence & external links ⚠ | **TO BE DONE**. R5. Silent, unrecoverable data loss on real production data, and the preview doesn't warn. Should land before T92. |
