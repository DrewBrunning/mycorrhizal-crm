...
| [T108](152-T108-contact-summary-missing-columns.md) · `GET /contacts` returns empty nickname and circles | **TO BE DONE**. R3. XS. Two DTO fields declared, read, and never selected. |
