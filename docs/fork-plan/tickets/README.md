...
| Ticket | Status |
|---|---|
| [T101](145-T101-merge-picker-strict-match.md) · Merge picker returns non-matching contacts | **TO BE DONE**. R4. S. Wrong results in the picker for an irreversible action. Fix client-side — the shared search endpoint must stay broad. |
| [T92](136-T92-bulk-merge-from-contacts-list.md) · Bulk merge from the contacts list | **TO BE DONE**. R4. M. Select-two-and-merge needs nothing; the suggested-pairs half waits on T93. |
| [T96](140-T96-import-duplicate-merge-review.md) · Import duplicate/merge review (web + Android) | **TO BE DONE**. R4. M+M. Web commits "Update Existing" blind and overwrites arrays; Android never merges at all. This is where the beta's duplicates came from. |
