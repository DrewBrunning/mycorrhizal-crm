...
| [T80](124-T80-web-address-editor-line-two.md) · Address editor has no line 2 / PO box / floor field | **DONE**, 2026-08-12. `AddressFields.tsx` gained PO Box/Apartment/Floor inputs, hidden by default and auto-revealed per-address when any is non-empty (VCF-imported data needs no extra tap). |
