...
fun CirclesScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text(stringResource(R.string.circles_title), style = MaterialTheme.typography.titleLarge)
                },
    ...
    if (showCreateDialog) {
        CircleNameDialog(
            title = stringResource(R.string.circles_new),
            initial = "",
...
private fun CircleListItem(
    ...
    if (renaming) {
        CircleNameDialog(
            title = stringResource(R.string.circles_rename),
            initial = circle.name,
    ...
    if (deleting) {
        AlertDialog(
            ...
            text = { Text(stringResource(R.string.circles_delete_confirm, circle.name)) },
            confirmButton = {
    ...
    AlertDialog(
        ...
        text = {
            OutlinedTextField(
                ...
                label = { Text(stringResource(R.string.circles_name)) },
                singleLine = true,
            )
        },
        confirmButton = {
