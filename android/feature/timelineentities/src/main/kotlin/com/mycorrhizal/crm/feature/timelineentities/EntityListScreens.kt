                        ...
                        items(uiState.items, key = { it.id }) { item ->
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    // T62 Android port: a gift/agenda item's URL wasn't
                                    // rendered anywhere before -- now shown as a second
                                    // line, colored brand green to match the contact
                                    // page's LinkRow (ContactDetailScreen.kt).
